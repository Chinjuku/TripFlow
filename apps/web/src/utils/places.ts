...
export const BUCKETS = {
  food: {
    ...
    label: 'Restaurant',
    plural: 'Food',
    labelKey: 'common.bucket.food',
    pluralKey: 'common.bucket.foodPlural',
    swatch: 'bg-rose-400',
  },
  cafe: {
    id: 'cafe',
    label: 'Café',
    plural: 'Cafés',
    labelKey: 'common.bucket.cafe',
    pluralKey: 'common.bucket.cafePlural',
    swatch: 'bg-amber-400',
  },
  stay: {
    id: 'stay',
    label: 'Stay',
    plural: 'Stays',
    labelKey: 'common.bucket.stay',
    pluralKey: 'common.bucket.stayPlural',
    swatch: 'bg-sky-400',
  },
  attraction: {
    id: 'attraction',
    label: 'Attraction',
    plural: 'Attractions',
    labelKey: 'common.bucket.attraction',
    pluralKey: 'common.bucket.attractionPlural',
    swatch: 'bg-primary',
  },
  bar: {
    id: 'bar',
    label: 'Bar',
    plural: 'Bars',
    labelKey: 'common.bucket.bar',
    pluralKey: 'common.bucket.barPlural',
  ...
  shopping: {
    ...
    label: 'Shopping',
    plural: 'Shopping',
    labelKey: 'common.bucket.shopping',
    pluralKey: 'common.bucket.shoppingPlural',
    swatch: 'bg-pink-400',
  },
  other: {
    id: 'other',
    label: 'Other',
    plural: 'Other',
    labelKey: 'common.bucket.other',
    pluralKey: 'common.bucket.otherPlural',
